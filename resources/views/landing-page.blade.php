...
<html lang="{{ app()->getLocale() }}">
    <head>
        <link rel="icon"  href="img/guitar-icon.png" type="image/png" sizes="16x16">
        <meta charset="utf-8">
    ...
    <body>
        <div id="app">
            <header class="with-background" style="background-image:url(img/bg1.jpg);">
                <div class="top-nav container">
                    <div class="top-nav-left">
                        <div class="logo" style="color:#FCDE43;">Guitar Shop</div>
                ...
                <div class="hero container">
                    <div class="hero-copy">
                        ...
                        <p>Guitar Shop is the world's largest music instrument retailer, with the greatest section.</p>
                    ...
                    <div class="hero-image">
                        <img src="img/1-2.png" alt="hero image">
                    </div> <!-- end hero-image -->
                </div> <!-- end hero -->
            </header>
